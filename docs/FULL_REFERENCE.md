...
```python
import texthumanize
print(texthumanize.__version__)  # 0.28.1
```
...
pip install texthumanize>=0.28.1
```
...
pip install git+https://github.com/ksanyok/TextHumanize.git@v0.28.1

# Or download a release archive
pip install https://github.com/ksanyok/TextHumanize/archive/refs/tags/v0.28.1.tar.gz
```

> **Tip:** Pin your version in `requirements.txt` for reproducible builds:
> ```
> texthumanize @ git+https://github.com/ksanyok/TextHumanize.git@v0.28.1
> ```
